...
class Maze:
    ...
    def __init__(self, maxRows, maxColumns, mesh="square", screen=False, load=False):
        ...
        if mesh == "square":
            ...
            if colRate < colRate:
                side = colRate
            self.board = mapSquare.MapSquare(
                self.maxRows * side,
            ...
            self.board = mapTriangle.MapTriangle(
            ...
            for j in i:
                ...
                if j.itemInside == "Parede":
                    ...
                    if diff_line:
                        ...
                        print(
                            "!!! warning: número de vítimas do ambiente maior do que número de dif. de acesso"
                        )
