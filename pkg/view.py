...
class View:
    ...
    def draw(self):
        ...
        self.board.listPlaces[self.model.agentPos[0]][self.model.agentPos[1]].setAgent(
            True
        )
        ...
        ##Desenha o objetivo
        self.board.listPlaces[self.model.goalPos[0]][self.model.goalPos[1]].setGoal(
            True
        )
